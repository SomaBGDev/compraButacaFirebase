    ...
    func cargaDatos(){
        //obtenemos datos en tiempo real
              ...
              ref.child("Cartelera").observe( .value) { (snapshot) in
                ...
                /* obtenemos el valor de la butaca
                let value = snapshot.childSnapshot(forPath: "0").childSnapshot(forPath: "butacas").childSnapshot(forPath: "0").childSnapshot(forPath: "0").value as! Bool
